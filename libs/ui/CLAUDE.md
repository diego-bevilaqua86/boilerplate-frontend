...
libs/ui/src/
  ...
  molecules/
    ...
    EmptyWidget, ErrorCard, FilterModal, LineChart, ModalFilters, ModalTransactionDetails, SearchFilterBar, TableFilterHeader, TablePlaceholder, TransactionItem, WithdrawalDepositSection
